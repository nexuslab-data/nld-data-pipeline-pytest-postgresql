...
from tests.data_pipelines.simple_data_pipeline_sql_query.simple_data_pipeline_sql_query import SimpleSqlQueryPipeline
...
TEST_FILE_FOLDER_PATH = os.path.join(
    ...
    "simple_data_pipeline_sql_query_test_files",
)
...
def test_load_using_local_file(postgresql: PostgreSQLConnectionWrapper) -> None:
    ...
    pipeline = SimpleSqlQueryPipeline(
